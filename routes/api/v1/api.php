...
// Today's Arrivals API routes - NO THROTTLING - OUTSIDE MAIN GROUP
Route::group(['prefix' => 'todays-arrivals', 'middleware' => ['localization']], function () {
    // Direct test route - no controller
