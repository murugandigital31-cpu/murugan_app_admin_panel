...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'employee_active_check']], function () {
        ...
        // Today's Arrival Branch Management
        Route::group(['prefix' => 'todays-arrival-branch', 'as' => 'todays-arrival-branch.','middleware'=>['module:promotion_management']], function () {
            Route::get('add-new', [TodaysArrivalBranchController::class, 'index'])->name('add-new');
            ...
            Route::put('update/{id}', [TodaysArrivalBranchController::class, 'update'])->name('update');
        ...
        Route::group(['prefix' => 'todays-arrival', 'as' => 'todays-arrival.'], function () {
            ...
            Route::put('update/{id}', [TodaysArrivalController::class, 'update'])->name('update');
