        ...
        <div class="row justify-content-center" id="printableArea">
            ...
            <div class="initial-38-1">
                ...
                @if($order['bring_change_amount'])
                    <h6><strong>{{ translate('Bring Change Note') }}</strong>: <span class="">{{translate('Please ensure the Deliveryman has '). \App\CentralLogics\Helpers::set_symbol($order['bring_change_amount']) . translate(' in change ready for the customer')}}</span></h6>
                @endif
