                ...
                <div class="navbar-vertical-content" id="navbar-vertical-content">
                    ...
                    @if(Helpers::module_permission_check(MANAGEMENT_SECTION['pos_management']))
                        ...
                        @if(Helpers::module_permission_check(MANAGEMENT_SECTION['promotion_management']))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/todays-arrival-branch*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.todays-arrival-branch.add-new')}}"
                                   title="{{translate('Today\'s Arrival Branches')}}"
                                >
                                    <i class="tio-shop nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Today\'s Arrival Branches')}}</span>
                                </a>
                            </li>

                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/todays-arrival*') && !Request::is('admin/todays-arrival-branch*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.todays-arrival.add-new')}}"
                                   title="{{translate('Today\'s Arrival')}}"
                                >
                                    <i class="tio-star-outlined nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Today\'s Arrival')}}</span>
                                </a>
                            </li>
